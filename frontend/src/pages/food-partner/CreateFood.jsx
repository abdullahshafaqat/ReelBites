...
const CreateFood = () => {
    ...
    const onDrop = (e) => {
        ...
        if (!file) { return; }
        if (!file.type.startsWith('videoin/')) { setFileError('Please drop a valid video file.'); return; }
        setFileError('');
        setVideoFile(file);
    };
    ...
    const onSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/api/food/create', formData, {
                withCredentials: true,
                headers: { 'Content-Type': 'multipart/form-data' }
            }); // <-- relative URL + withCredentials
